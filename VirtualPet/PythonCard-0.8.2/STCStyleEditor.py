...
#---STC events------------------------------------------------------------------
    ...
    def checkBraces(self, style):
        if style == stc.STC_STYLE_BRACELIGHT and self.braceInfo.has_key('good'):
        ...
        elif style == stc.STC_STYLE_BRACEBAD and self.braceInfo.has_key('bad'):
...
[wxID_COMMONDEFDLG, wxID_COMMONDEFDLGCANCELBTN, wxID_COMMONDEFDLGCOMDEFNAMETC, wxID_COMMONDEFDLGOKBTN, wxID_COMMONDEFDLGPROPTYPERBX, wxID_COMMONDEFDLGSTATICBOX1] = map(lambda _init_ctrls: wx.NewId(), range(6))
