...
def player_turn():
    ...
    while not valid_play:                                                     
        ...
        #print "debug: active_suit = ", active_suit
        #print "debug: up_card.rank = ", up_card.rank
        #print "debug: selected_card.suit = ", selected_card.suit 
        #print "debug: selected_card.rank = ", selected_card.rank
